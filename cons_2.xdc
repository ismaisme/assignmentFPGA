...
## Audio output via PMOD JA
set_property PACKAGE_PIN C17 [get_ports {left}]
set_property IOSTANDARD LVCMOS33 [get_ports {left}]

set_property PACKAGE_PIN D18 [get_ports {right}]
set_property IOSTANDARD LVCMOS33 [get_ports {right}]

## (Ensure you connect PMOD JA pin 7 (D17) to GND externally)
# Clock signal
...
#set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { left }]; #IO_L4N_T0_15 Sch=aud_pwm
